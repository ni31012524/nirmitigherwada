        ...
        <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end">
          ...
          {showSocial && (
            <div className="mt-3 mb-1 bg-black/90 border border-white/20 rounded-2xl shadow-xl p-4 flex flex-col items-center space-y-4 animate-fadeInUp">
              ...
              {/* LinkedIn */}
              <a href="https://linkedin.com/in/nirmitigherwada" target="_blank" rel="noopener noreferrer" className="hover:text-blue-400 transition flex items-center space-x-2" title="LinkedIn">
