    ...
    <div className="relative min-h-[90vh] flex flex-col justify-center items-center overflow-hidden bg-black">
      ...
      <section className="relative z-30 grid grid-cols-1 sm:grid-cols-2 gap-6 md:gap-10 mt-4 md:mt-8 w-full max-w-5xl px-2 md:px-4 animate-fadeInUp">
        ...
        >
          ...
          <p className="text-white text-sm md:text-base">Coordinated & exceuted a high-impact Industry Professional Networking Event.</p>
        </button>
        {/* Card 4 */}
        <button
        ...
        >
          ...
          <p className="text-white text-sm md:text-base">Secured premium B2B deals through strategic content, paid ads, and luxury partnerships.</p>
        </button>
      </section>
    </div>
  );
